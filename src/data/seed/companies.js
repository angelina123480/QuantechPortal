const COMPANIES = [
  ...
  { name: 'Continental Freight Logistics', contactName: 'Rita Abdallah', contactEmail: 'rita.abdallah@continentalfreight.com', contactPhone: '+961 1 789 012', industry: 'Logistics & Transportation', teamId: 'tm1', isActive: false },
...
function buildCompanies() {
  const now = new Date();
  return COMPANIES.map((c) => ({ ...c, isActive: c.isActive !== false, createdAt: now }));
}
